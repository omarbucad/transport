...
<head>
    ...
    <title>Transport App - Privacy Policy</title>
    ...
    .privacy-page .privacy-box a {
        font-size: 14px;
        text-decoration: none;
        color: #00BCD4; }

    .privacy-page .privacy-box .logo {
        margin-bottom: 20px; }

    .privacy-page .privacy-box .logo a {
        font-size: 36px;
        display: block;
        width: 100%;
        text-align: center;
    ...
    .privacy-page .privacy-box .logo small {
        display: block;
        width: 100%;
        text-align: center;
        color: #fff;
...
<body class="privacy-page">
   ...
   <div class="privacy-box">
    ...
    <div class="logo">
        <a href="<?php echo site_url("login") ?> " >Transport<b>APP</b></a>
        <small>Trackerteer Web Developer Corporation</small>
    </div>

    <div class="card privacy-content container ">

        <div id='ppHeader'>Transport App Privacy Policy</div>
        <div id='ppBody'>
            ...
            <div class='ppConsistencies'>
                ...
                <br />
                <div class='innerText'>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address or other details to help you with your experience.</div>
                <br>
                ...
                <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To follow up with them after correspondence (live chat, email or phone inquiries)</div><span id='infoPro'></span>
                <br>
                ...
                <br>
                <div class='innerText'>All transactions are processed through a gateway provider and are not stored or processed on our servers.</div><span id='coUs'></span>
                <br>
                ...
                <br />
                <div class='innerText'>We do not sell, trade, or otherwise transfer to outside parties your Personally Identifiable Information.</div><span id='trLi'></span>
                <br>
                ...
                <div class='innerText'>We have not enabled Google AdSense on our site but we may do so in the future.</div><span id='calOppa'></span>
                <br>
                ...
                <div class='innerText'>
                    ...
                    <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> On our Privacy Policy Page
                        <br>
                    </div>
                    ...
                    <div class='innerText'>We do not specifically market to children under the age of 13 years old.</div><span id='ftcFip'></span>
                    <br>
                    ...
                    <div class='innerText'>
                        ...
                        <div class='innerText'>
                            ...
                            <div class='innerText'>trackerteer.com/transport</div>
                            <div class='innerText'>Clark Freeport Zone</div>Angeles, Pampanga 2010
                            <div class='innerText'>Philippines</div>
                            <div class='innerText'>mhar@trackerteer.com</div>
                            <div class='innerText'>
                                <br>Last Edited on 2017-05-18</div>
                            </div>
                        </div>
