                            ...
                            <tbody>
                                <?php foreach($emergency_report  as $key => $row) : ?>
                                    <tr>
                                        ...
                                        <td><a href="javascript:void(0);" class="btn btn-primary btn-xs view-map" data-id="<?php echo $row->emergency_id; ?>" data-href="<?php echo site_url('app/mechanic/view_emergency_report/').$row->emergency_id; ?>"><i class="material-icons" style="font-size: 16.5px;">my_location</i> View Report</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
