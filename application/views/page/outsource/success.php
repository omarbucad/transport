	...
	<div class="body">
			...
			<?php if($success_type == 'insert') : ?>
				<div class="col-lg-6 col-xs-12">
					...
					<dl class="dl-horizontal">
						...
						<dt>Account No</dt>
						<dd><?php echo $data["account_no"]; ?></dd>
						<dt>Billing Address</dt>
						<dd><?php echo $data["billing_address"]; ?></dd>
					</dl>
				</div>
			<?php else : ?>
		...
		<div class="row">
			<div class="col-lg-6 col-xs-6">
				<a href="<?php echo site_url("app/outsource/") ?>" class="btn btn-primary waves-effect">Close</a>
				<a href="<?php echo site_url("app/outsource/add") ?>" class="btn btn-info waves-effect">Add New Account</a>
			</div>
			<div class="col-lg-6 col-xs-6 text-right">
				<button class="btn btn-danger waves-effect remove-data" data-id="<?php echo $last_id; ?>" data-href="<?php echo site_url("app/outsource/remove"); ?>">Remove This Data</button>
			</div>
		</div>
