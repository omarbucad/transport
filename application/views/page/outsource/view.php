...
<div class="block-header">
    <h2>
        ...
        <a href="<?php echo site_url("app/outsource/add"); ?>" class="btn btn-primary"><i class="material-icons" style="position: relative;font-size: 16.5px;">add_circle_outline</i> Add Outsource</a>
    </h2>
</div>

<div style="margin-bottom: 20px;">
    <div class="collapse" id="collapseExample">
        <?php $this->load->view('page/outsource/search') ?>
    </div>
</div>
                        ...
                        <tbody>
                             <?php foreach ($result as $key => $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <nobr>
                                            <button data-href="<?php echo site_url("app/outsource/update/".$row->outsource_id) ?>" class="btn btn-xs btn-info waves-effect btn-update"><i class="material-icons" style="font-size: 16px;">update</i> Update</button>
                                            <button href="Javascript:void(0);" class="btn btn-xs btn-danger waves-effect remove-data" data-id="<?php echo $row->outsource_id; ?>" data-href="<?php echo site_url("app/outsource/remove"); ?>" data-name="<?php echo $row->company_name; ?>"><i class="material-icons" style="font-size: 16px;">cancel</i> Remove</button>
                                        </nobr>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
